...
namespace SampleGameEngine {
    ...
    /// </summary>
    public sealed class BodyEffectRangeEvent : RangeSequenceEvent {
        [Tooltip("エフェクトの再生情報")]
    ...
    /// </summary>
    public sealed class BodyEffectRangeEventHandler : RangeSequenceEventHandler<BodyEffectRangeEvent> {
