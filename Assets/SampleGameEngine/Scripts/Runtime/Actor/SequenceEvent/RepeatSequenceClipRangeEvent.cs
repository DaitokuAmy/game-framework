...
namespace SampleGameEngine {
    ...
    /// </summary>
    public sealed class RepeatSequenceClipRangeEvent : RangeSequenceEvent {
    ...
    /// イベントハンドラ
    /// </summary>
    public sealed class RepeatSequenceClipRangeEventHandler : RangeSequenceEventHandler<RepeatSequenceClipRangeEvent> {
