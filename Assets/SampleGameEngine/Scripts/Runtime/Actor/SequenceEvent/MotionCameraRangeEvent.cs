...
namespace SampleGameEngine {
    ...
    /// </summary>
    public sealed class MotionCameraRangeEvent : RangeSequenceEvent {
        // ブレンド情報
        [Serializable]
        public struct Blend {
    ...
    /// イベントハンドラ
    /// </summary>
    public sealed class MotionCameraRangeEventHandler : RangeSequenceEventHandler<MotionCameraRangeEvent> {
