...
namespace SampleGameEngine {
    ...
    /// Body用のギミック制御イベント
    /// </summary>
    public sealed class BodyAnimationGimmickSingleEvent : BodyGimmickSingleEvent {
    ...
    /// イベントハンドラ
    /// </summary>
    public sealed class BodyAnimationGimmickSingleEventHandler : BodyGimmickSingleEventHandler<AnimationGimmick, BodyAnimationGimmickSingleEvent> {
        /// <summary>
        /// ギミック実行時処理
        /// </summary>
