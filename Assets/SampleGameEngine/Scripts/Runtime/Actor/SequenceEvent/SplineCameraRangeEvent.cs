...
namespace SampleGameEngine {
    ...
    /// </summary>
    public sealed class SplineCameraRangeEvent : RangeSequenceEvent {
        // ブレンド情報
        [Serializable]
        public struct Blend {
    ...
    /// イベントハンドラ
    /// </summary>
    public sealed class SplineCameraRangeEventHandler : RangeSequenceEventHandler<SplineCameraRangeEvent> {
