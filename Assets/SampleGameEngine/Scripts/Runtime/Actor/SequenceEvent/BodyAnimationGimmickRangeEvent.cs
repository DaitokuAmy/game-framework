...
namespace SampleGameEngine {
    ...
    /// Body用のギミック制御イベント
    /// </summary>
    public sealed class BodyAnimationGimmickRangeEvent : BodyGimmickRangeEvent {
    ...
    /// イベントハンドラ
    /// </summary>
    public sealed class BodyAnimationGimmickRangeEventHandler : BodyGimmickRangeEventHandler<AnimationGimmick, BodyAnimationGimmickRangeEvent> {
        /// <summary>
        /// 入り処理
        /// </summary>
