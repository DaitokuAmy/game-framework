...
namespace SampleGameEngine {
    ...
    /// </summary>
    public sealed class BodyEffectSignalEvent : SignalSequenceEvent {
        [Tooltip("エフェクトの再生情報")]
    ...
    /// </summary>
    public sealed class BodyEffectSignalEventHandler : SignalSequenceEventHandler<BodyEffectSignalEvent> {
