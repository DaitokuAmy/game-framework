...
namespace SampleGameEngine {
    ...
    /// 重力係数制御用のイベント
    /// </summary>
    public sealed class GravityScaleRangeEvent : RangeSequenceEvent {
        [Tooltip("変化させるスケール値")]
        public float scale;
    }
    ...
    /// イベントハンドラー
    /// </summary>
    public sealed class GravityScaleRangeEventHandler : RangeSequenceEventHandler<GravityScaleRangeEvent> {
