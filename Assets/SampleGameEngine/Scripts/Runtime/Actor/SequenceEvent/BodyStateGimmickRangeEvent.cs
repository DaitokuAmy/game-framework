...
namespace SampleGameEngine {
    ...
    /// Body用のギミック制御イベント
    /// </summary>
    public sealed class BodyStateGimmickRangeEvent : BodyGimmickRangeEvent {
    ...
    /// イベントハンドラ
    /// </summary>
    public sealed class BodyStateGimmickRangeEventHandler : BodyGimmickRangeEventHandler<StateGimmick, BodyStateGimmickRangeEvent> {
        /// <summary>
        /// 入り処理
        /// </summary>
