...
namespace SampleGame {
    ...
    public static class ActorExtensions {
        ...
        /// プレイヤーエンティティの初期化処理
        /// </summary>
        public static async UniTask<ActorEntity> SetupPlayerAsync(this ActorEntity source, Battle.BattlePlayerModel model, LayeredTime parentLayeredTime, IScope unloadScope, CancellationToken ct) {
