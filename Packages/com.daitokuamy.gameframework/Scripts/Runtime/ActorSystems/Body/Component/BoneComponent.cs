    ...
    public class BoneComponent : SerializedBodyComponent {
        ...
        protected override void InitializeInternal() {
            ...
            if (_meshComponent != null) {
                // Mesh更新時にGraphを再構築
                _meshComponent.RefreshedEvent += BuildGraph;
            }
        }
        ...
        private void BuildGraph() {
            ...
            // 追従対象の骨を列挙
            var partsList = _meshComponent.GetMeshPartsList();
            ...
            // Graph/Outputの生成
            _graph = PlayableGraph.Create($"{nameof(BoneComponent)}({Body.Transform.name})");
