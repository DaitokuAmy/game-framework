...
namespace GameFramework.EnvironmentSystem.Editor {
    ...
    public sealed class EnvironmentDefaultSettingsPropertyDrawer : PropertyDrawer {
        /// <summary>
        /// Style情報
        /// </summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (_foldout) {
                ...
                if (GUI.Button(rect, "Get Settings")) {
                    ...
                    _customReflection.objectReferenceValue = RenderSettings.customReflectionTexture;
                ...
                if (GUI.Button(rect, "Set Settings")) {
                    ...
                    RenderSettings.customReflectionTexture = _customReflection.objectReferenceValue as Cubemap;
